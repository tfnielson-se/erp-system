  ...
  const handleDeleteProject = () => {
	...
	return (
		<tr>
			...
			<td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
				<Link to={`/projects/:id`} href="#" tabindex="0" role="link" onClick={""}>
					...
					<button onClick={handleDeleteProject} className="inline-flex items-center px-3 py-1 rounded-md gap-x-2 text-gray-300 bg-emerald-100/60 dark:bg-gray-800 text-sm font-normal capitalize">
						Delete
					</button>
			</td>
		</tr>
